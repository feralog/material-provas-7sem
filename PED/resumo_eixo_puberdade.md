...
## O que é puberdade e o que a desencadeia

Puberdade é o período de transição entre a fase infantil e a adulta, marcado por mudanças hormonais, aparecimento de **caracteres sexuais secundários**, **aceleração do crescimento** (estirão) e aquisição de **fertilidade**. É influenciada por fatores genéticos, ambientais e socioeconômicos, nutricionais e de saúde. Os três eventos fisiológicos que a compõem são a **diminuição da sensibilidade do gonadostato** ao feedback negativo dos esteroides, a **gonadarca** e a **adrenarca**.

Os marcos cronológicos mudam um pouco conforme a sociedade de referência, e a prova costuma cobrar a versão da SBP:

| Marco | Meninas | Meninos |
| --- | --- | --- |
| Início normal (SBP) | 8 a 13 anos | 9 a 14 anos |
| Início normal (SBEM) | 8 a 14 anos | 10 a 15 anos |
| Primeiro sinal | Telarca (M2) | Volume testicular > 4 mL (G2) |
| Puberdade precoce | Antes dos 8 anos | Antes dos 9 anos |
| Atraso puberal | Sem telarca aos 13 anos | Sem aumento testicular aos 14 anos |

> A puberdade traz consigo a **fertilidade**. Numa criança de 6 anos com corpo de 11, isso significa risco real de gravidez, além de bullying, isolamento social, sexualização precoce e incongruência entre maturidade física e emocional. O papel do médico é validar os medos da família e garantir a privacidade da criança no exame físico, sempre com acompanhante e explicando cada passo.

---

## Estadiamento de Tanner

O estadiamento de Tanner (SMR, *Sexual Maturity Rating*) descreve mamas (M) na menina, genitália (G) no menino e pelos pubianos (P) em ambos, sempre de 1 a 5. Ele é descrito **por inspeção**, e o estágio de mama e o de pelos são anotados separadamente — por isso a paciente do caso é **M3P2**, e não simplesmente "Tanner 3".

#### Mamas — sexo feminino

- **M1 (infantil):** apenas elevação da papila, sem tecido mamário palpável.
- **M2 (broto mamário):** pequeno nódulo sob a aréola, que se torna levemente elevada e alargada. É o **início da puberdade**.
- **M3 (crescimento):** maior aumento da mama e da aréola, **sem separação de seus contornos**.
- **M4 (duplo contorno):** projeção da aréola e da papila formando uma segunda elevação acima do nível da mama.
- **M5 (adulta):** a aréola recua ao contorno geral da mama, restando apenas a papila projetada.

![Estágios de Tanner do sexo feminino, de M1 a M5](img:pg19)

#### Genitália — sexo masculino

- **G1 (infantil):** testículos, escroto e pênis de tamanhos infantis.
- **G2 (aumento testicular):** escroto e testículos aumentam de volume, com pele escrotal mais fina, avermelhada e texturizada. É o **início da puberdade** (> 4 mL).
- **G3 (crescimento do pênis):** aumento do comprimento do pênis e crescimento adicional dos testículos.
- **G4 (glande):** aumento do diâmetro do pênis e desenvolvimento da glande; o escroto escurece.
- **G5 (adulto):** genitália com tamanho e formato de adulto.

#### Pelos pubianos — ambos os sexos

`P1` ausência total de pelos; `P2` pelos longos, finos e levemente pigmentados (grandes lábios ou base do pênis); `P3` pelos mais escuros, grossos e encaracolados sobre a sínfise púbica; `P4` pelos de tipo adulto cobrindo área menor que a do adulto, **sem atingir as coxas**; `P5` distribuição adulta clássica (triangular na mulher, podendo subir até o umbigo no homem) e na face interna das coxas.
...
| PPC de causa orgânica | Hamartomas, tumores do SNC, radiação ou trauma |
| PPP (periférica) | Independente de GnRH: cistos ovarianos, tumores de suprarrenal, McCune-Albright |
| Variantes do normal | Telarca precoce isolada ou adrenarca precoce isolada |
